...
turn_90_degrees_right = {"up": "right", "down": "left", "left": "up", "right": "down"}

arrow_mapper = {"up": "^", "down": "v", "left": "<", "right": ">"}
...
if __name__ == "__main__":
    ...
    # task 2
    num_of_obsticales_that_lead_to_cycle = guard_surfer.check_if_cycle_possible_for_each_cell(
        grid, guard_starting_position, visited_cells
    )
